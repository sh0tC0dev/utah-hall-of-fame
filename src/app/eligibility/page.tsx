...
const criteria = [
  ...
  { title: "Limitations", text: "A maximum of two (2) persons may be inducted into the Utah Trapshooters Hall of Fame in each year. Inductees may be living or deceased, with only one deceased inductee per year." },
